...
case class BackendUser(userName: String, email: String, interests: Interests)
...
case class GetUsersResponse(executionStatus: ExecutionStatus, users: List[BackendUser])
